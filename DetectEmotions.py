...
async def detect_emotions(emotion_processor, emotion_model, emotion_labels, audio_data, sample_rate=16000):
    ...
    with sr.Microphone() as source:
        ...
        if keyboard.is_pressed("space"):
            ...
            try:
                ...
                voice_emotions = await detect_emotions(emotion_model, emotion_processor, emotion_labels, audio_data_np)
